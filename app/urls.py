...
urlpatterns = [
    ...
    path('staffs/',app_views.StaffsListView.as_view(),name = 'staffs'),
    path('staffs/add/',app_views.StaffAddView.as_view(),name = 'staff_add'),
    path('staffs/delete/',app_views.StaffDeleteView.as_view(),name = 'staff_delete'),
